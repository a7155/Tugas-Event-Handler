...
public class TicTacToe implements ActionListener{
 ...
 //Membuat label siapa yang menang.
 Label lbl=new Label("");

 //Membuat button untuk papan permainan
 ...
 //panel layout untuk pemenang game
 panel.setLayout(new FlowLayout());

 //Setting up buttons background color
 btn1.setBackground(new Color(150,250,255));
 btn2.setBackground(new Color(150,250,255));
 btn3.setBackground(new Color(150,250,255));
 btn4.setBackground(new Color(150,250,255));
 btn5.setBackground(new Color(150,250,255));
 btn6.setBackground(new Color(150,250,255));
 btn7.setBackground(new Color(150,250,255));
 btn8.setBackground(new Color(150,250,255));
 btn9.setBackground(new Color(150,250,255));
 ...
 //Menambahkan action listener untuk button click
 ...
 if (win) {
     lbl.setText("Selamat Pemain " + letter + " Menang!");
        btn1.setEnabled(false);
        btn2.setEnabled(false);
        btn3.setEnabled(false);
        btn4.setEnabled(false); 
        ...
        lbl.setText("Permainan berahir Seri");
        btn1.setEnabled(false);
        btn2.setEnabled(false);
        btn3.setEnabled(false);
        btn4.setEnabled(false); 
